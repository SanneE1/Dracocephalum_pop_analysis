...
surv_gam <- gam(survival_t1 ~ ln_stems_t0 + population + s(year_t0, bs = 're') +
                  s(rock) + s(slope) + 
...
surv_mod <- gam(as.formula(paste0("survival_t1 ~ ln_stems_t0 + population + s(year_t0, bs = 're') +", 
...
saveRDS(surv_mod, file = "results/seasons_surv.rds")
...
growth_gam <- gam(ln_stems_t1 ~ ln_stems_t0 + population + s(year_t0, bs = 're') + s(rock) + s(slope) + 
                    s(herb_shading_t0) + s(shrub_shading_t0) + 
                    s(pr_dormant) + s(tas_dormant) +
                    s(pr_summer)+ s(tas_summer) + 
                    s(pr_spring) + s(tas_spring) +
...
growth_mod <- gam(as.formula(paste0("ln_stems_t1 ~ ln_stems_t0 + population + s(year_t0, bs = 're') +", 
...
saveRDS(growth_mod, file = "results/seasons_growth.rds")
...
flowp_gam <- gam(flower_p_t0 ~ ln_stems_t0 + population + s(year_t0, bs = 're') + s(rock) + s(slope) + 
                   s(herb_shading_t0) + s(shrub_shading_t0) + 
                   s(pr_dormant) + s(tas_dormant) +
                   s(pr_summer)+ s(tas_summer) + 
                   s(pr_spring) + s(tas_spring) +
...
flowp_mod <- gam(as.formula(paste0("flower_p_t0 ~ ln_stems_t0 + population + s(year_t0, bs = 're') +", 
...
saveRDS(flowp_mod, file = "results/seasons_flowp.rds")
...
seedp_gam <- gam(seed_p_t0 ~ ln_stems_t0 + population + s(year_t0, bs = 're') + s(rock) + s(slope) + 
                   s(herb_shading_t0) + s(shrub_shading_t0) + 
                   s(pr_dormant) + s(tas_dormant) +
                   s(pr_summer)+ s(tas_summer) + 
                   s(pr_spring) + s(tas_spring) +
...
seedp_mod <- gam(as.formula(paste0("seed_p_t0 ~ ln_stems_t0 + population + s(year_t0, bs = 're') +", 
...
saveRDS(seedp_mod, file = "results/seasons_seedp.rds")
...
seedn_gam <- gam(est_seed_n_t0 ~ ln_stems_t0 + population + s(year_t0, bs = 're') + s(rock) + s(slope) + 
                   s(herb_shading_t0) + s(shrub_shading_t0) + 
                   s(pr_dormant) + s(tas_dormant) +
                   s(pr_summer)+ s(tas_summer) + 
                   s(pr_spring) + s(tas_spring) +
...
seedn_selected <- names(edf_seedp)[edf_seedn > 1 & p_seedn < 0.05]

seedn_mod <- gam(as.formula(paste0("est_seed_n_t0 ~ ln_stems_t0 + population + s(year_t0, bs = 're') +", 
                                   paste(seedp_selected, collapse = "+"))),
                 data = surv_df %>% filter(seed_p_t0 == 1),
                 family = Gamma(link = 'log'),
                 method="GCV.Cp",
...
saveRDS(seedn_mod, file = "results/seasons_seedn.rds")
